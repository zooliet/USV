...
class CLIDialog(CTkToplevel):
    def __init__(
        self,
        master,
        title: str = "List Dialog",
        label_text: str = "List Dialog",
    ...
    def create_widgets(self):
        ...
        self.combobox.grid(
            row=1, column=0, columnspan=2, padx=40, pady=20, sticky="new"
        )
    ...
    def ok_event(self):
        self.user_input = self.combobox.get()
        self.grab_release()
        self.destroy()
